# Full Stack Calculator (FastAPI + JS)

Calculadora de ingeniería con arquitectura desacoplada. Utiliza un motor matemático en Python para procesar operaciones y una interfaz moderna con estética *Glassmorphism* en el cliente.
...
1.  **Entorno Virtual:** Asegúrate de tener la carpeta `venv` con las dependencias instaladas (`fastapi`, `uvicorn`, `pydantic`).
